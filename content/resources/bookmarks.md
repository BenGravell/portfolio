...
<nav class="bookmarks-jump" aria-label="Bookmark categories">
  ...
  <a href="#search">Search & graphs</a>
  <a href="#systems">Systems</a>
  <a href="#signals">Signals</a>
  <a href="#math">Math & statistics</a>
  <a href="#design">Design & cities</a>
...
- [Google Trajax](https://github.com/google/trajax/tree/main)
...
- [MAPIE](https://scikit-learn-contrib.github.io/MAPIE/1.4.0/)
...
- [Pixi](https://prefix-dev.github.io/pixi/latest/) and [uv](https://github.com/astral-sh/uv)
...
- [Matrix profiles](https://stumpy.readthedocs.io/en/stable/Tutorial_The_Matrix_Profile.html) and [pattern matching](https://stumpy.readthedocs.io/en/latest/Tutorial_Pattern_Matching.html)
...
<section class="bookmark-card bookmark-card-wide" id="miscellany" markdown="1">
...
- [A useful Colab notebook](https://colab.research.google.com/drive/1m7-XiBmO3CtHJOj9XiKjFNxQnd0o2ez7)
...
- [NeurIPS 2016 workshop](https://neurips.cc/virtual/2016/workshop/6211)
...
@media screen and (max-width: 768px) {
  ...
  .bookmark-card-wide { grid-column: auto; columns: auto; }
}
</style>
